...
function scenario(){return {
  ...
  directives:[
    {id:"D1",name:"Provision",good:"food",rate:4,dur:3,deadline:3,req:[],must:true,reward:{buildRate:{1:1}},rp:40},
    {id:"D2",name:"Metalworks",good:"metal",rate:3,dur:1,deadline:4,req:["D1"],must:true,reward:{buildRate:{2:1},demolish:1},rp:70},
    {id:"D3",name:"Electronics",good:"electronics",rate:3,dur:1,deadline:5,req:["D2"],must:true,reward:{unlock:["assembler","lab"],buildRate:{3:1}},rp:120},
    {id:"D4",name:"Assembly",good:"components",rate:5,dur:4,deadline:16,req:["D3"],must:true,reward:{},rp:160},
    ...
    {id:"D7",name:"Hydroworks",good:"water",rate:6,dur:3,deadline:10,req:[],must:false,reward:{},rp:50},
    {id:"D8",name:"Circuits",good:"electronics",rate:4,dur:2,deadline:7,req:[],must:false,reward:{},rp:50},
    {id:"D9",name:"Alloyworks",good:"alloy",rate:4,dur:4,deadline:11,req:[],must:false,reward:{},rp:50}
  ]};}
